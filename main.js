...
(function () {
    ...
    const drivingLicenceNumber = 'FAHIY004088RA9DC'; // Set to your driver licence
    const testDate = '15/04/2026'; // Set your desired test date, format in DD/MM/YYYY
    const postcode = 'HA7 4BQ'; // Set your postcode
    const instructorReferenceNumber = null ; // Set to the instructor's reference number or leave as null if not applicable
